...
import 'package:Power_Team/GroupInfo4.dart';
...
class GroupDetails4 extends StatelessWidget {
  const GroupDetails4({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 20),
          CircleAvatar(
            backgroundImage: AssetImage('assets/images/coachjuliagroup.jpg'),
            radius: 60,
          ),
          SizedBox(height: 10),
          Text(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GroupInfo4()),
              );
            },
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 5),
