...
import 'package:Power_Team/Groupdetails5.dart';
...
class GroupDiscussion5 extends StatelessWidget {
  const GroupDiscussion5({super.key});
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => GroupDetails5()),
                    );
                  },
                  child: CircleAvatar(
