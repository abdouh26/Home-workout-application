...
class SecondDetailedPost extends StatefulWidget {
  const SecondDetailedPost({super.key});

  _SecondDetailedPost createState() => _SecondDetailedPost();
}

class _SecondDetailedPost extends State<SecondDetailedPost> {
