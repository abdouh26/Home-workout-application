...
import 'package:Power_Team/GroupInfo2.dart';
...
class GroupDetails2 extends StatelessWidget {
  const GroupDetails2({super.key});
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GroupInfo2()),
              );
            },
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 5),
