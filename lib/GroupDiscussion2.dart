...
import 'package:Power_Team/Groupdetails2.dart';
...
class GroupDiscussion2 extends StatelessWidget {
  const GroupDiscussion2({super.key});
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => GroupDetails2()),
                    );
                  },
                  child: CircleAvatar(
                    backgroundImage: AssetImage('assets/images/gymgroup.jpg'),
                    radius: 20,
                  ),
                ),
                SizedBox(width: 10),
