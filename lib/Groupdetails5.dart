...
import 'package:Power_Team/GroupInfo5.dart';
...
class GroupDetails5 extends StatelessWidget {
  const GroupDetails5({super.key});
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GroupInfo5()),
              );
            },
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 5),
