...
class SteveStory extends StatefulWidget {
  const SteveStory({super.key});

  @override
  _StoryState createState() => _StoryState();
}

class _StoryState extends State<SteveStory> {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    // Profile Picture
                    CircleAvatar(
                      backgroundImage: AssetImage('assets/images/steve.png'),
                      radius: 20,
                    ),
                    SizedBox(width: 10),
