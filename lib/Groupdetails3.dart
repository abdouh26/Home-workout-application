...
import 'package:Power_Team/GroupInfo3.dart';
...
class GroupDetails3 extends StatelessWidget {
  const GroupDetails3({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 20),
          CircleAvatar(
            backgroundImage: AssetImage('assets/images/familyworkoutgroup.jpg'),
            radius: 60,
          ),
          SizedBox(height: 10),
          Text(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GroupInfo3()),
              );
            },
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 5),
