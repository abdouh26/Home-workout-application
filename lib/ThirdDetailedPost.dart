...
class ThirdDetailedPost extends StatefulWidget {
  const ThirdDetailedPost({super.key});

  _ThirdDetailedPost createState() => _ThirdDetailedPost();
}

class _ThirdDetailedPost extends State<ThirdDetailedPost> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/cablesworkout.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                    SizedBox(height: 10),
