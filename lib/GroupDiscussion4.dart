...
import 'package:Power_Team/Groupdetails4.dart';
...
class GroupDiscussion4 extends StatelessWidget {
  const GroupDiscussion4({super.key});
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => GroupDetails4()),
                    );
                  },
                  child: CircleAvatar(
